...
public final class LauncherThemeManager {
    ...
    public enum Theme {
        H3("h3", "H3", R.string.launcher_theme_h3),
        WOOD("wood", "Wood", R.string.launcher_theme_wood),
        GLASS("glass", "Glass", R.string.launcher_theme_glass),
        LOTUS("lotus", "Lotus", R.string.launcher_theme_lotus),
        MARBLE("marble", "Marble", R.string.launcher_theme_marble),
        WATER("water", "Water", R.string.launcher_theme_water);

        private final String id;
        private final String alias;
        private final int labelRes;

        Theme(String id, String alias, int labelRes) {
            this.id = id;
            this.alias = alias;
